...
import { EventModel, RegisterChildModel, RegisterChildEventModel, RegisterChildEventModelAnswer } from "../../../../core/client/api.client";
...
export class EventRegistrationComponent extends FormBase {
    options = [
        RegisterChildEventModelAnswer.Yes,
        RegisterChildEventModelAnswer.No,
        RegisterChildEventModelAnswer.Maybe
    ]
    ...
    private getEvents(control: AbstractControl): Array<RegisterChildEventModel> {
        return Object.keys(control.value).map(eventId => 
